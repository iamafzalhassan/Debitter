...
import com.example.debitter.ui.editor.components.TotalsFooter
    ...
    Scaffold(
        ...
        bottomBar = {
            TotalsFooter(
                ...
                onAdvanceChange = { onEvent(EditorEvent.SetAdvance(it)) },
                onPreview = onPreview,
                onReset = { onEvent(EditorEvent.Reset) },
                showsActions = !WindowInsets.isImeVisible,
        ...
        Column(
            ...
            ChargeSectionList(
                ...
                onRemove = { onEvent(EditorEvent.RemoveCharge(section = ChargeSection.STATUTORY, id = it.id)) },
            ...
            ChargeSectionList(
                ...
                onRemove = { onEvent(EditorEvent.RemoveCharge(section = ChargeSection.OTHER, id = it.id)) },
